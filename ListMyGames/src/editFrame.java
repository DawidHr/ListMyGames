...

{
	...
	private void setPanelCenter() {
		...
		gameTypeComboBox.setSelectedItem(game.type);
	...
	ActionListener listener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			String title1 = gameNameField.getText();
			String type1 = gameTypeComboBox.getSelectedItem().toString();
			String tyt =game.getTitle();
			System.out.println(title1);
			System.out.println(type1);
			System.out.println(tyt);
			db.editRow(title1, type1, tyt);
